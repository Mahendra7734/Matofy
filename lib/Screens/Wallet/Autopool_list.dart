...
class Auto_pool_list extends StatefulWidget {
  const Auto_pool_list({Key? key}) : super(key: key);

  @override
  State<Auto_pool_list> createState() => _Auto_pool_listState();
}

class _Auto_pool_listState extends State<Auto_pool_list> {
  var h;
  var w;
  //var url;
  var data =[];
