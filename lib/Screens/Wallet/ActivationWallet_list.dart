...
class ActivationWallet extends StatefulWidget {
  const ActivationWallet({Key? key}) : super(key: key);

  @override
  State<ActivationWallet> createState() => _ActivationWalletState();
}

class _ActivationWalletState extends State<ActivationWallet> {
  var h;
  var w;
  //var url;
  var data =[];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Activation Wallet list"),
