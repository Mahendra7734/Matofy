...
class Referal_list extends StatefulWidget {
  const Referal_list({Key? key}) : super(key: key);

  @override
  State<Referal_list> createState() => _Referal_listState();
}

class _Referal_listState extends State<Referal_list> {
  var h;
  var w;
  //var url;
  var data =[];
