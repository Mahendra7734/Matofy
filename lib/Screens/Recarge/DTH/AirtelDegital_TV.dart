...
class Airtel_DegitalTV extends StatefulWidget {

  Airtel_DegitalTV({Key? key}) : super(key: key);
  List sliderImages=[];
  @override
  State<Airtel_DegitalTV> createState() => _Airtel_DegitalTVState();
}

class _Airtel_DegitalTVState extends State<Airtel_DegitalTV> {
  var h;
  var w;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: LIGHT_COLOR,
        title: Text("Airtel Degital TV",style: TextStyle(color:WHITE_COLOR,fontSize: textSizeMedium ),),
      ),
