...
class TataSky extends StatefulWidget {

  TataSky({Key? key}) : super(key: key);
  List sliderImages=[];
  @override
  State<TataSky> createState() => _TataSkyState();
}

class _TataSkyState extends State<TataSky> {
  var h;
  var w;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: LIGHT_COLOR,
        title: Text("Tata play (Formerly Tata...",style: TextStyle(color:WHITE_COLOR,fontSize: textSizeMedium ),),
      ),
