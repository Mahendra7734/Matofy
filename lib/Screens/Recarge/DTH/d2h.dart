...
class _D2hState extends State<D2h> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: LIGHT_COLOR,
        title: Text("D2H",style: TextStyle(color:WHITE_COLOR,fontSize: textSizeMedium ),),
      ),
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              hintText: "Customer ID/VC Number/Registered Mobile Number",
