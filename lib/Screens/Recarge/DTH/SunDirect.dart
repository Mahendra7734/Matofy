...
class SunDirect extends StatefulWidget {

  SunDirect({Key? key}) : super(key: key);
  List sliderImages=[];
  @override
  State<SunDirect> createState() => _SunDirectState();
}

class _SunDirectState extends State<SunDirect> {
  var h;
  var w;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: LIGHT_COLOR,
        title: Text("Sun Direct",style: TextStyle(color:WHITE_COLOR,fontSize: textSizeMedium ),),
      ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "To Know your customer ID , SMS 'ID' from your registered telephone number or SMS 'CID' <Smart Card Number> from non registered telephone number to 992517734",
                          style: TextStyle(
                        ...
                        Text(
                          "Enter your pack amount in rupees",
                          style: TextStyle(
                              color: BLACK_GREYCOLOR, fontSize: textSizeSmall),
                        ),
                        SizedBox(
