...
class Landline_bill_detals extends StatefulWidget {

  Landline_bill_detals({Key? key}) : super(key: key);
  List sliderImages=[];
  @override
  State<Landline_bill_detals> createState() => _Landline_bill_detalsState();
}

class _Landline_bill_detalsState extends State<Landline_bill_detals> {
  var h;
  var w;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: LIGHT_COLOR,
        title: Text("Land line Bill",style: TextStyle(color:WHITE_COLOR,fontSize: textSizeMedium ),),
      ),
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              hintText: "Customer ID/Mobile No/User ID",
                        ...
                        Text(
                          "Please enter a valid Customer ID/Mobile No/User ID",
                          style: TextStyle(
