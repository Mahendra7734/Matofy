...
class Jaipur_Vidyut extends StatefulWidget {

  Jaipur_Vidyut({Key? key}) : super(key: key);
  List sliderImages=[];
  @override
  State<Jaipur_Vidyut> createState() => _Jaipur_VidyutState();
}

class _Jaipur_VidyutState extends State<Jaipur_Vidyut> {
  var h;
  var w;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: LIGHT_COLOR,
        title: Text("Jaipur Vidyut Vitaran",style: TextStyle(color:WHITE_COLOR,fontSize: textSizeMedium ),),
      ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        "VIEW SANPLE BILL",
                        style: TextStyle(
                            color: LIGHT_COLOR,fontWeight: FontWeight.bold),
                      ),
                    ],
                  ),
                ),
