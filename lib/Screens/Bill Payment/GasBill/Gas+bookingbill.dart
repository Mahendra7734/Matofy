...
class Gas_booking_bill extends StatefulWidget {

  Gas_booking_bill({Key? key}) : super(key: key);
  List sliderImages=[];
  @override
  State<Gas_booking_bill> createState() => _Gas_booking_billState();
}

class _Gas_booking_billState extends State<Gas_booking_bill> {
  var h;
  var w;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: LIGHT_COLOR,
        title: Text("Gas Booking Bill",style: TextStyle(color:WHITE_COLOR,fontSize: textSizeMedium ),),
      ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Please enter a valid CRN No between 5 and 15 digits(eg.ABCD12345)",
                          style: TextStyle(
