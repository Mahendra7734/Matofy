...
import 'Gas+bookingbill.dart';

class GasCylinder extends StatefulWidget {

  GasCylinder({Key? key}) : super(key: key);
  List sliderImages=[];
  @override
  State<GasCylinder> createState() => _GasCylinderState();
}
...
class _GasCylinderState extends State<GasCylinder> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: LIGHT_COLOR,
        title: Text("Gas Cylinder Bill Recharge",style: TextStyle(color:WHITE_COLOR,fontSize: textSizeMedium ),),
      ),
                  ...
                  Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: (){
                              Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Gas_booking_bill()));
                            },
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Container(
                                      ...
                                      child: Image.asset('assets/Images/GAILGAS_logo-removebg-preview.png')),
                                  SizedBox(
                                    width: w*0.04,
                                  ),
                                  Expanded(
                              ...
                              children: [
                                Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Image.asset('assets/Images/bc2f5576-baa1-40f0-8195-5d021d91f111-removebg-preview.png'),
                                    )),
                                SizedBox(
                                  width: w*0.04,
                                ),
