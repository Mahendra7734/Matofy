...
class UploadProfileImage extends StatefulWidget {
  UploadProfileImage({Key? key}) : super(key: key);
...
class _UploadProfileImageState extends State<UploadProfileImage> {
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  style: ButtonStyle(
                    backgroundColor:
                        MaterialStateProperty.all<Color>(LIGHT_COLOR),
                  ),
                  onPressed: () {
        ...
        child: Form(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsets.only(left: 10.0, right: 10, top: h * 0.05),
                    child: SizedBox(
                      child: Card(
                        elevation: 5,
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle:
                                TextStyle(fontSize: 16, color: BLACK_GREYCOLOR),
                            focusedBorder: OutlineInputBorder(
                                // borderRadius: BorderRadius.circular(8),
                                borderSide: BorderSide.none),
                            border: OutlineInputBorder(
         ...
         Padding(
                ...
                child: DefaultButton(
                    ...
                    press: () {
                      UpdateProfileData();
                      profileImage==null?"":Fluttertoast.showToast(msg: 'Profile Update Successfully',
  ...
  ProfileData() async {
    ...
    try {
      var res = await ApiProvider()
          .postRequest(apiUrl: 'edit-profile-user', data: data);
      print(res);
  ...
  UpdateProfileData() async {
    ...
    var data = {
      ...
      'email': Mobile,
      'profileImage':
          pickedImage.toString() == 'null' ? null : pickedImage!.path
    };
    try {
